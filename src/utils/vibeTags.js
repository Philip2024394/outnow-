...
export const VIBE_TAGS = [
  ...
  // Social
  { id: 'meet',        label: 'Meet New People',   emoji: '👋', category: 'social' },
  { id: 'good_chat',   label: 'Good Conversation', emoji: '💬', category: 'social' },
  { id: 'chill',       label: 'Chill & Relaxed',   emoji: '😌', category: 'social' },
