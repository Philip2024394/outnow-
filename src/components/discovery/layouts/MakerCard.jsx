...
export default function MakerCard({ open, session, onClose, showToast, onGuestAction, onMeetSent, onLike }) {
  useOverlay()
  const { user }  = useAuth()
          ...
          <div className={styles.card}>
            ...
            <div className={styles.categoryHeader}>
              <div>
                ...
                <span className={styles.categorySlogan}>Maker Profile</span>
              </div>
            </div>
            ...
            {session.tradeRole && (
              <div className={styles.infoRow}>
                ...
                <span className={styles.infoValue}>
                  {session.tradeRole === 'selling' ? '🏷️ Selling' : session.tradeRole === 'buying' ? '🛍️ Buying' : '🏷️ Selling & Buying'}
                </span>
              </div>
            )}
