      ...
      <div className="ws-container">
        ...
        <ScrollReveal delay={0.1}>
          <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
            ...
            {agent.instagram && <a href={`https://instagram.com/${agent.instagram}`} target="_blank" rel="noopener noreferrer" style={{ width: 56, borderRadius: 14, textDecoration: 'none', background: 'linear-gradient(135deg, #833AB4, #E1306C, #F77737)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>📸</a>}
          </div>
        </ScrollReveal>
