...
const CATEGORIES = [
  ...
  { id: 'home',        emoji: '🏠', label: 'Home & Furniture' },
  { id: 'handmade',    emoji: '🎨', label: 'Handmade & Crafts' },
  { id: 'food',        emoji: '🍔', label: 'Food & Beverages' },
  { id: 'health',      emoji: '💊', label: 'Health & Wellness' },
  { id: 'vehicles',    emoji: '🚗', label: 'Vehicles & Parts' },
  { id: 'services',    emoji: '🔧', label: 'Services' },
  { id: 'tech',        emoji: '💻', label: 'Tech & Software' },
  { id: 'education',   emoji: '📚', label: 'Education & Courses' },
  { id: 'agri',        emoji: '🌾', label: 'Farm & Agriculture' },
]
