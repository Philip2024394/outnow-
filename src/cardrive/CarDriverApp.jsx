  ...
  if (!driverRegistered) {
    return (
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: '#080808', alignItems: 'center', justifyContent: 'center', padding: 32, textAlign: 'center' }}>
        <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'rgba(141,198,63,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20, fontSize: 40 }}>🚗</div>
        <h2 style={{ fontSize: 22, fontWeight: 900, color: '#fff', margin: '0 0 8px' }}>Become an INDOO Car Driver</h2>
            ...
            {tier && (
              <div style={{ padding: 16, borderRadius: 16, background: `rgba(${tier.current.id === 'elite' ? '141,198,63' : '255,255,255'},0.06)`, backdropFilter: 'blur(16px)', border: `1.5px solid ${tier.current.color}40`, marginBottom: 12 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                  <img src="https://ik.imagekit.io/nepgaxllc/Sporty%20green%20and%20black%20hatchback.png?updatedAt=1775634925566" alt="" style={{ width: 32, height: 32, objectFit: 'contain' }} />
                  <div style={{ flex: 1 }}>
              ...
              <div style={{ padding: 12, borderRadius: 12, background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.1)', marginBottom: 12 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                  <span style={{ fontSize: 11, fontWeight: 800, color: '#fff', display: 'flex', alignItems: 'center', gap: 6 }}>
                    <img src="https://ik.imagekit.io/nepgaxllc/Sporty%20green%20and%20black%20hatchback.png?updatedAt=1775634925566" alt="" style={{ width: 16, height: 16, objectFit: 'contain' }} />
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 150, display: 'flex' }}>
          ...
          <div style={{ width: 300, background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderLeft: '3px solid rgba(141,198,63,0.3)', display: 'flex', flexDirection: 'column', animation: 'slideLeft 0.3s ease', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '12px 0' }}>
              ...
              <button onClick={() => { localStorage.removeItem('indoo_car_driver_terms_accepted'); localStorage.removeItem('indoo_car_driver_terms_accepted_at'); setTermsAccepted(false); setDrawerOpen(false) }} style={{ padding: '14px 16px', margin: '0 12px 8px', display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, width: 'calc(100% - 24px)', cursor: 'pointer', textAlign: 'left' }}>
